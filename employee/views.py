...
def registration(request):
    ...
    if request.method == "POST":
        ...
        user = User.objects.create_user(first_name=fn, last_name=ln, email=em, password=pwd, username=un)
        EmployeeDetail.objects.create(user=user, empcode=ec,resume=resume)
...
def edit_myexperience(request):
    ...
    if request.method == "POST":
        ...
        experience = EmployeeExperience(user=user, company1name=company1name, company1desig=company1desig,
                                        company1salary=company1salary, company1duration=company1duration,
                                        company2name=company2name, company2desig=company2desig,
                                        company2salary=company2salary, company2duration=company2duration,
                                        company3name=company3name, company3desig=company3desig,
                                        company3salary=company3salary, company3duration=company3duration)

        experience.save()

    return render(request, 'edit_myexperience.html',{'experience':experience})
...
def edit_myeducation(request):
    ...
    if request.method == "POST":
        ...
        education = EmployeeEducation(user=user, coursepg=coursepg, schoolclgpg=schoolclgpg,
                                        yearofpassingpg=yearofpassingpg, percentagepg=percentagepg,
                                        coursegra=coursegra, schoolclggra=schoolclggra,
                                        yearofpassinggra=yearofpassinggra, percentagegra=percentagegra,
                                        coursessc=coursessc, schoolclgssc=schoolclgssc,
                                        yearofpassingssc=yearofpassingssc, percentagessc=percentagessc,
                                        coursehsc=coursehsc, schoolclghsc=schoolclghsc,
                                        yearofpassinghsc=yearofpassinghsc, percentagehsc=percentagehsc)

        education.save()

    return render(request, 'edit_myeducation.html')
